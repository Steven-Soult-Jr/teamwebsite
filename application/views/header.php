...
<nav class="navbar navbar-default" role="navigation" >
    ...
    <div class="row" style="display:inline-block; width: 60%; margin: 0 auto;">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="display:inline-block; float: right; width: 18%;" >
            ...
            <ul class="nav navbar-nav navbar-right" >
                <div class="btn-group" role="group" aria-label="...">
                    <a class="btn btn-xs btn-success" href="<?php echo base_url()?>index.php/upload_item">Sell</a></button>
                    <a href="<?php echo base_url()?>index.php/messaging" type="button" class="btn btn-xs btn-default">
